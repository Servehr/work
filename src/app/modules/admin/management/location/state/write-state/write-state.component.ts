...
export const stateNameRequired = (control: AbstractControl): ValidationErrors | null => 
{
   return control.value?.length === 0 || control.value === null ? { stateNameRequired : 'stateNameRequired' } :  null
}


@Component({
  selector: 'app-write-state',
  standalone: true,
  ...
  templateUrl: './write-state.component.html',
  styleUrl: './write-state.component.scss'
})
export class WriteStateComponent implements OnInit {
   ...
   constructor()
   {
      this.stateForm = new FormGroup(
        {
          stateName: new FormControl('', [stateNameRequired]),
